    ...
    return(
        <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{backgroundImage: `url(${bg})`}}>
            <form className='w-[90%] h-[600px] max-w-[500px] bg-[rgba(0,0,0,0.38)] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]'>
                ...
                <button type="submit" className='w-full h-[60px] bg-blue-500 text-white rounded-full text-[18px] font-semibold hover:bg-white-600'>Sign Up</button>
                <p className='text-white text-[16px]' >Already have an account? <a href="/Signin" className='text-blue-400 hover:underline'>Login</a></p>
            </form>
        </div>
    )
}
